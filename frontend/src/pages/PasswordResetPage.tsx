...
const PasswordResetPage = observer(({ location, classes, history }: IPasswordResetPageProps) => {
  ...
  const allValid = computed(() => emailIsValid && passwordIsValid && passwordConfirmIsValid);
  ...
  const onChangePasswordConfirmation = action((e: React.ChangeEvent<HTMLInputElement>) => {
      ...
      <div className={classes.rootInner}>
        <Paper className={classes.content} square>
          ...
          <TextField
            ...
            helperText={
              (!emailIsValid && "Email must be non-empty and contain an '@' character") || ''
            }
            fullWidth
          ...
          <TextField
            ...
            helperText={(!passwordIsValid && 'Password must be longer than 8 characters') || ''}
            fullWidth
            onKeyDownCapture={handlerKeyDown}
          />
          <TextField
            ...
            helperText={(!passwordConfirmIsValid && 'Must match password field above') || ''}
            fullWidth
            onKeyDownCapture={handlerKeyDown}
          />
          <div style={{ display: 'flex', justifyContent: 'end' }}>
            <ButtonGroup className={classes.buttons}>
              ...
              <Button onClick={onReset} className={classes.buttonError} disabled={!allValid}>
